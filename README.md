...
В качестве признаков использовались различные эмбеддинги, полученные из моделей BERT, CLIP, TF-IDF, ResNet. Целью было проверить, сможет ли модель CatBoost эффективно объединить различные типы эмбеддингов для предсказания CTR.
